    ...
    def user_interface(self, window):
        while True:
            if self.running:
                ...
                window.addstr(4, 10, self.account_str)
                window.addstr(5, 10, self.uptime_str)
                window.addstr(6, 10, self.tweet_str)
                window.addstr(7, 10, self.retweet_str)
                window.addstr(7, 45, self.config_reload_string)
                window.addstr(8, 10, self.follow_str)
                window.addstr(8, 45, self.following_str)
                window.addstr(9, 10, self.fave_str)
                window.addstr(9, 45, "Press Ctrl-C to initiate a terminate sequence")
                window.addstr(11, 10, "[*] Current Status")
